-- Arquivo SQL unificado para TAVERNA DA IMPRESSÃO
-- Este arquivo contém todo o esquema do banco de dados e dados iniciais
...
-- Primeiro, criamos o banco de dados (se não existir)
-- CREATE DATABASE IF NOT EXISTS `u135851624_taverna` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
-- USE `u135851624_taverna`;

-- Desativar verificação de chaves estrangeiras durante o processo de criação de tabelas
SET FOREIGN_KEY_CHECKS = 0;

-- Remover tabelas existentes (para garantir uma instalação limpa)
