-- Script corrigido para reinstalação do banco de dados TAVERNA DA IMPRESSÃO
-- Este script resolve o problema de restrições de chave estrangeira ao eliminar tabelas

-- Iniciar com as configurações corretas
...
-- Isso é crítico para permitir a eliminação de tabelas com relações
SET FOREIGN_KEY_CHECKS = 0;

-- 2. ELIMINAR TODAS AS TABELAS NA ORDEM CORRETA
-- Sempre eliminar primeiro as tabelas filhas, depois as tabelas pai

-- Tabelas com referências para order_items
DROP TABLE IF EXISTS order_items;

-- Tabelas com referências para cart_items
DROP TABLE IF EXISTS cart_items;

-- Tabelas com referências para produtos
DROP TABLE IF EXISTS product_images;
DROP TABLE IF EXISTS customization_options;

-- Tabelas com referências para orders
DROP TABLE IF EXISTS orders;

-- Tabelas com referências para carts
DROP TABLE IF EXISTS carts;

-- Tabelas com referências para addresses
DROP TABLE IF EXISTS addresses;

-- Tabelas com referências para categories
DROP TABLE IF EXISTS products;
DROP TABLE IF EXISTS categories;

-- Tabelas com referências para users
...
-- Índice para cart_items (identificado como ausente pelo diagnóstico)
...
CREATE INDEX product_images_product_main_idx ON product_images (product_id, is_main);
...
-- Adicionar imagens aos produtos (ausentes no diagnóstico)
...
-- 6. REATIVAR VERIFICAÇÃO DE CHAVES ESTRANGEIRAS
